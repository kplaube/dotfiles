...
alias cd_webhooks='cd_projetos; cd data-webhooks/'
...
alias workon_multicontent='workon multicontent; cd_multicontent'
...
alias workon_router='workon router; cd_router'
alias workon_shiatsu='workon_presentation; cd_shiatsu'
alias workon_webhooks='workon webhooks; cd_webhooks'
