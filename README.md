...
First of all, you'll need to install [direnv](https://direnv.net/index.html#install), Zsh, [Vim](https://apple.stackexchange.com/questions/325697/installation-of-mac-brew-vim-version-8-1), and [VS Code](https://code.visualstudio.com/docs/setup/setup-overview) by using your system's package manager.
